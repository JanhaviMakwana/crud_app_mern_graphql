...
import {GET_ARTICLE, DELETE_ARTICLE, GET_ARTICLES} from '../graphgl/articleQueries';
            ...
            {function ({loading, error, data}) {
                ...
                return (
                    <div>
                        ...
                        <p>{article.content}</p>
                        <p className="btn-group"><Link to={`/articles/${article.id}/edit`} className="btn btn-info">
                            Edit</Link>
